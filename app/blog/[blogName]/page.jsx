            ...
            <main className="background">
                ...
                <section className="blog py-8 md:pt-40 md:pb-10 lg:pt-44 lg:pb-14">
                    <div className="container">
                        ...
                        {cartBlog.map((blog, index) => {
                            return <div key={index} className="flex flex-col w-full p-5 md:p-10 shadow-normal rounded-2xl text-black dark:text-white bg-white dark:bg-zinc-700">
                                {/* <!-- Title --> */}
