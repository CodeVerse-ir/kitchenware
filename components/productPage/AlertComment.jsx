...
export default function AlertComment({ showComment, handleShowComment, handleSaveComment }) {
    ...
    return (
        <>
            {/* <!-- Cart Star --> */}
            <div className={`${showComment ? "visible opacity-100" : "invisible opacity-0"} alert-survey`}>
                {/* <!-- Header --> */}
                <div className="flex items-center justify-between">
                    <span>
                        افزودن نظر جدید
                    </span>
                    <svg className="w-4 h-4 md:w-5 md:h-5 lg:w-6 lg:h-6 hover:text-orange-300 transition-colors cursor-pointer" onClick={handleShowComment}>
                        <use href="#x-mark">
                        </use>
                    </svg>
                </div>
                ...
                <div className="space-y-5">
                    <div className="space-y-2.5">
                        ...
                        <input
                            ...
                            type="text" placeholder="مثال : کیفیت محصول" maxLength="50" value={commentTitle} onChange={(e) => setCommentTitle(e.target.value)} />
                    </div>
                    ...
                    <div className="space-y-2.5">
                        ...
                        <textarea
                            ...
                            name="" id="" placeholder="مثال : خوب بود." maxLength="700" value={comment}
            ...
            <AlertSave textAlert="لطفاً تمامی فیلدها را پر کنید." showAlert={showAlert} setShowAlert={setShowAlert} />
        </>
    )
}
