...
export default function ChangeInformation({ showComment, setShowComment }) {
  return (
    <>
      ...
      <div
        className="flex items-center justify-start w-full mt-10 p-5 md:p-10 gap-x-10 font-MorabbaMedium text-lg md:text-xl lg:text-2xl text-black dark:text-white bg-white dark:bg-zinc-700 shadow-normal rounded-2xl select-none">
