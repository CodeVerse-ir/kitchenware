                ...
                <div className="container">
                    ...
                    <div className="flex flex-col items-center md:flex-row">
                        ...
                        <div className="h-auto w-72 md:min-w-80 md:ml-5">
                            <Image src={contact} className="rotate-[25deg]" alt="contact"></Image>
                        </div>
                        {/* <!-- text --> */}
                        <div className="text-zinc-700 dark:text-white">
                            ...
                            <p className="text-justify text-base font-thin md:text-xl xl:text-2xl">
                                مزه و لذت آشپزی را به خانه خود بیاورید ! از تخته‌های برش تا ماشین‌های رنده و دستگاه‌های آشپزی حرفه‌ای، ما
                                همه چیز برای تجربه‌ی شیرین‌ترین غذاها و خوراکی‌ها را داریم. با ما همراه باشید و لذت آشپزی را با لوازم
                                اشپزخانه متنوع و باکیفیت، به زندگی خود بیاورید.
                            </p>
                        </div>
                    </div>
