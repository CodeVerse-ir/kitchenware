            ...
            <section className="category-banner mt-8 mb-10 md:my-20">
                <div className="container">
                    ...
                    <div
                        ...
                        <Link href={`/products/category/${encodeURIComponent('لوازم پخت و پز')}`} className="category-top-right pr-7 md:pr-12 md:pt-[5.44rem] pt-[2.44rem]">
                        ...
                        <Link href={`/products/category/${encodeURIComponent('لوازم برقی')}`} className="category-top-left md:pr-12 md:pt-[5.44rem] pt-[2.44rem] pr-7">
                            <h4 className="font-DanaBold md:text-4xl/normal text-xl/normal">
                                لوازم برقی
                            </h4>
                            <sub className="text-base font-DanaMedium md:text-xl/normal">
