...
export default function NavMobile({ handleDarkMode }) {
  ...
  return (
    <>
      ...
      <div className="flex md:hidden items-center justify-between h-16 px-4  bg-white dark:bg-zinc-700">
        ...
        {/* <!-- Nav --> */}
        <div
          className={`nav fixed top-0 bottom-0 ${navbar ? 'right-0' : '-right-64'} w-64 p-4 bg-white dark:bg-zinc-700 overflow-y-scroll transition-all z-20`}>
          ...
          {/* <!-- Nav Footer --> */}
          <div
            className="flex flex-col items-start gap-y-2 py-8 mt-8 text-orange-300 border-t border-t-gray-100 dark:border-t-white/10">

            <a href="" className="inline-flex items-center  w-full p-2 gap-x-2.5">
            ...
            <Link href="/products" className={`${'/products' === pathname && "bg-orange-200/20 rounded-md"} w-full p-2`}>
        ...
        {/* <!-- Theme --> */}
        <div className="inline-block toggle-theme select-none text-zinc-700 dark:text-white" onClick={handleDarkMode}>
